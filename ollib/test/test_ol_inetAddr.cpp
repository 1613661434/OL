...
void test_ipv4()
{
    ...
    cout << "普通IPv4构造: " << addr.toString() << " [OK]" << endl;
    ...
    assert(any4.port() == 80);
    cout << "IPv4任意地址: " << any4.toString() << " [OK]" << endl;
    ...
    cout << "原生IPv4转换: " << fromNative4.toString() << " [OK]" << endl;
...
void test_ipv6()
{
    ...
    cout << "普通IPv6构造: " << addr.toString() << " [OK]" << endl;
    ...
    assert(any6.port() == 80);
    cout << "IPv6任意地址: " << any6.toString() << " [OK]" << endl;
    ...
    cout << "原生IPv6转换: " << fromNative6.toString() << " [OK]" << endl;
